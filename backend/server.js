...
// --- Seed local login credentials for the staff captured from the old app's live data ---
const seed = loadSeed();
...
credentials.ensureSeeded(credentialSeeds);

// --- Configure Firestore (optional). Falls back to local JSON automatically if unreachable. ---
store.configureCloud({
  apiKey: process.env.FIREBASE_API_KEY,
  projectId: process.env.FIREBASE_PROJECT_ID,
});
store.retryCloudIfConfigured().catch(() => {});
